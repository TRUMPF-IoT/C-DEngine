...
namespace CDEngine.CDUtils.Zlib
{
    ...
    public partial class ZipFile
    {
        ...
        {
            return ZipFile.Read(fileName, null, null);
        }
        ...
        {
            return Read(zipStream, null, null);
        }
        ...
        private static void ReadIntoInstance(ZipFile zf)
        {
            ...
            try
            {
                ...
                if (success)
                {
                    ...
                    if (zf._diskNumberWithCd == 0xFFFF)
                        throw new Exception("Spanned archives with more than 65534 segments are not supported at this time.");
            ...
            catch (Exception ex1)
            {
                ...
                throw new Exception("Cannot read that as a ZipFile", ex1);
            }
        ...
        private static void Zip64SeekToCentralDirectory(ZipFile zf)
        {
            ...
            if (datum != ZipConstants.Zip64EndOfCentralDirectoryRecordSignature)
                throw new Exception(String.Format("  Bad signature (0x{0:X8}) looking for ZIP64 EoCD Record at position 0x{1:X8}", datum, s.Position));
        ...
        {
            Stream s = zf.ReadStream;
            int signature = CDEngine.CDUtils.Zlib.SharedUtilities.ReadSignature(s);
            ...
            if (signature == ZipConstants.Zip64EndOfCentralDirectoryRecordSignature)
            {
                ...
                if (DataSize < 44)
                    throw new Exception("Bad size in the ZIP64 Central Directory.");
                ...
                signature = CDEngine.CDUtils.Zlib.SharedUtilities.ReadSignature(s);
                if (signature != ZipConstants.Zip64EndOfCentralDirectoryLocatorSignature)
                    throw new Exception("Inconsistent metadata in the ZIP64 Central Directory.");
            ...
            if (signature != ZipConstants.EndOfCentralDirectorySignature)
            {
                ...
                throw new Exception(String.Format("Bad signature ({0:X8}) at position 0x{1:X8}",
        ...
        public static bool IsZipFile(Stream stream, bool testExtract)
        {
            ...
            try
            {
                ...
                using (ZipFile zip1 = ZipFile.Read(stream, null, null))
                {
                    if (testExtract)
                    {
