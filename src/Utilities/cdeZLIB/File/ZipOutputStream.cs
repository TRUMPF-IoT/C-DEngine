...
// ------------------------------------------------------------------
//
// SPDX-FileCopyrightText: Copyright (c) 2009 Dino Chiesa.
// All rights reserved.
//
...
namespace CDEngine.CDUtils.Zlib
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = CDEngine.CDUtils.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        /// </summary>
        public CDEngine.CDUtils.Zlib.CompressionMethod CompressionMethod
        {
            get;
            set;
        }
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = CDEngine.CDUtils.Zlib.ZipOutputStream.DefaultEncoding;
        ...
        private CDEngine.CDUtils.Zlib.CrcCalculatorStream _entryOutputStream;
    ...
    internal class ZipContainer
    {
...
#if !NETCF
        public CDEngine.CDUtils.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
        ...
        public CDEngine.CDUtils.Zlib.CompressionStrategy Strategy
        {
            get
            {
