...
// ------------------------------------------------------------------
//
// SPDX-FileCopyrightText: Copyright (c) 2006-2010 Dino Chiesa.
// All rights reserved.
//
...
namespace CDEngine.CDUtils.Zlib
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = CDEngine.CDUtils.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = CDEngine.CDUtils.Zlib.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        public string FileName
        {
            ...
            set
            {
                if (_container.ZipFile == null)
                    throw new Exception("Cannot rename; this is not supported in ZipOutputStream/ZipInputStream.");

                // rename the entry!
                if (String.IsNullOrEmpty(value)) throw new Exception("The FileName must be non empty and non-null.");
        ...
        public Stream InputStream
        {
            ...
            set
            {
                if (this._Source != ZipEntrySource.Stream)
                    throw new Exception("You must not set the input stream for this entry.");
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)CDEngine.CDUtils.Zlib.CompressionMethod.None)
                    _CompressionLevel = CDEngine.CDUtils.Zlib.CompressionLevel.None;
                else if (CompressionLevel == CDEngine.CDUtils.Zlib.CompressionLevel.None)
                    _CompressionLevel = CDEngine.CDUtils.Zlib.CompressionLevel.Default;
        ...
        ///
        /// <seealso cref="CompressionMethod"/>
        internal CDEngine.CDUtils.Zlib.CompressionLevel CompressionLevel
        {
            get
            {
            ...
            set
            {
                ...
                if (value == CDEngine.CDUtils.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == CDEngine.CDUtils.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == CDEngine.CDUtils.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short)CDEngine.CDUtils.Zlib.CompressionMethod.None;
                else
                    _CompressionMethod = (short)CDEngine.CDUtils.Zlib.CompressionMethod.Deflate;
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = CDEngine.CDUtils.Zlib.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new Exception("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new Exception("The filename must be non-null and non-empty.");
        ...
        private CDEngine.CDUtils.Zlib.CompressionLevel _CompressionLevel;
