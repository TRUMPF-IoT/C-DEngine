    ...
    internal static class SharedUtilities
    {
...
#endif
            if (n != block.Length) throw new Exception(String.Format(message, s.Position));
        ...
        internal static DateTime PackedToDateTime(Int32 packedDateTime)
        {
            ...
            if (!success)
            {
                ...
                throw new Exception(String.Format("Bad date/time format in the zip file. ({0})", msg));
    ...
    public class CountingStream : System.IO.Stream
    {
        ...
        public override long Position
        {
            ...
            set
            {
                ...
                // workitem 10178
                CDEngine.CDUtils.Zlib.SharedUtilities.Workaround_Ladybug318918(_s);
            }
        }
