...
// ------------------------------------------------------------------
//
// SPDX-FileCopyrightText: Copyright (c) 2006, 2007, 2008, 2009 Dino Chiesa and Microsoft Corporation.
// All rights reserved.
//
...
namespace CDEngine.CDUtils.Zlib
{
    ...
    internal delegate CDEngine.CDUtils.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
