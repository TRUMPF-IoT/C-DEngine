...
namespace CDEngine.CDUtils.Zlib
{
    ...
    IDisposable
    {
        ...
        /// </remarks>
        internal CDEngine.CDUtils.Zlib.CompressionStrategy Strategy
        {
        ...
        internal CDEngine.CDUtils.Zlib.CompressionMethod CompressionMethod
        {
            get
            {
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = CDEngine.CDUtils.Zlib.ZipFile.DefaultEncoding;
        ...
        public Int32 MaxOutputSegmentSize
        {
            ...
            set
            {
                if (value < 65536 && value != 0)
                    throw new Exception("The minimum acceptable segment size is 65536.");
        ...
        public ZipFile(string fileName)
        {
            ...
            {
                throw new Exception(String.Format("Could not read {0} as a zip file", fileName), e1);
            }
        }
        ...
        public ZipFile(string fileName, System.Text.Encoding encoding)
        {
            ...
            {
                throw new Exception(String.Format("{0} is not a valid zip file", fileName), e1);
            }
        }
        ...
        private void _InitInstance(string zipFileName, TextWriter statusMessageWriter)
        {
            ...
            CompressionLevel = CDEngine.CDUtils.Zlib.CompressionLevel.Default;
#if !NETCF
        ...
        private CDEngine.CDUtils.Zlib.CompressionStrategy _Strategy = CDEngine.CDUtils.Zlib.CompressionStrategy.Default;
        private CDEngine.CDUtils.Zlib.CompressionMethod _compressionMethod = CDEngine.CDUtils.Zlib.CompressionMethod.Deflate;
...
#if !NETCF
        internal CDEngine.CDUtils.Zlib.ParallelDeflateOutputStream ParallelDeflater;
