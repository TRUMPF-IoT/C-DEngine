    ...
    public class TheCommonUtilsTests
    {
        ...
        public void SerializeObjectToJSONStringWithCycleTest()
        {
            ...
            if (TheCommonUtils.cdeNewtonJSONConfig.ReferenceLoopHandling != cdeNewtonsoft.Json.ReferenceLoopHandling.Serialize)
            {
                ...
                ClassicAssert.AreEqual(expectedJsonCycle, jsonCycle);
            }
        }
        ...
        public void CStrDateTimeOffsetTest()
        {
            ...
            ClassicAssert.AreEqual(expectedString, dateString);
        }
        ...
        {
            {
                ...
                ClassicAssert.AreEqual(expectedValue, dateTimeOffsetValue);
            }
            {
        ...
        public void GetRandomUIntTest(int factor)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                ClassicAssert.IsTrue(result >= 1 && result < 1000);
                if (result != 1)
                {
            ...
            for (int i = 1; i < 1000; i++)
            {
                ...
                ClassicAssert.IsFalse(valueCount < acceptableCount, $"Count for {i} not acceptable: {valueCount} should be {acceptableCount}");
            }
        }
        ...
        public void TestGetSafeFileName()
        {
            ...
            ClassicAssert.AreEqual(safeFileName, $"a+b_c_d_{timestamp:yyyyMMddHHmmfffff}.json", "Actual File Name: " + safeFileName);
        }
        ...
        public void TestGetSafeFileNameNoTimeStamp()
        {
            ...
            ClassicAssert.IsTrue(safeFileName.Equals("a+b_c_d.json"), "Actual File Name: " + safeFileName);
        }
        ...
        public void TestGetSafeFileNameInvalidExtension()
        {
            ...
            ClassicAssert.IsTrue(safeFileName.Equals("a+b_c_d.jso"), "Actual File Name: " + safeFileName);
        }
    }
}